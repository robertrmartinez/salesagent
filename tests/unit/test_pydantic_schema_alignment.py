...
KNOWN_SCHEMA_LIBRARY_MISMATCHES: dict[str, set[str]] = {
    ...
    "/schemas/latest/media-buy/get-media-buy-delivery-request.json": {
        ...
        "attribution_window",  # Schema defines attribution window, library doesn't have it yet
        "include_package_daily_breakdown",  # Schema defines daily breakdown flag, library doesn't have it yet
